package com.iloveplan.android.view.habit;
...
import com.iloveplan.android.databinding.HabitListBinding;
import com.iloveplan.android.databinding.HabitListItemBinding;
...
import com.iloveplan.android.view.memo.MemoEditActivity;
import com.iloveplan.android.view.memo.MemoViewActivity;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

public class HabitListFragment extends MainFragment {
    ...
    private HabitListBinding mBinding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return (mBinding = DataBindingUtil.inflate(inflater, R.layout.habit_list, container, false)).getRoot();
    }
    ...
    private class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> implements ItemTouchHelperCallback.Adapter {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new ViewHolder(HabitListItemBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
        }
        ...
        class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            HabitListItemBinding binding;

            ViewHolder(HabitListItemBinding binding) {
